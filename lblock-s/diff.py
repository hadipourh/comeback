...
class Diff:
    ...
    def __init__(self, params) -> None:
        ...
        self.sbox_inequalities[0] = ["- a1 + a3 - b0 - b2 + b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b2 - b3 + p0 >= -1",
                                    "- b1 + p2 >= 0",
                                    ...
                                    "a2 - a3 - b1 - b2 + p0 >= -2",
                                    "- a1 - a2 + b0 - b1 - b2 + p0 >= -3"]
        self.sbox_inequalities[1] = ["- a1 + a3 - b0 + b2 - b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b2 - b3 + p0 >= -1",
                                    "- b1 + p2 >= 0",
                                    ...
                                    "- a0 - a1 + a2 + b0 - b1 - b2 - b3 >= -4",
                                    "- a1 - a2 + b0 - b1 - b3 + p0 >= -3"]
        self.sbox_inequalities[2] = ["- a1 + a3 - b0 - b1 + b2 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b0 - b2 + p0 >= -1",
                                    "- b3 + p2 >= 0",
                                    ...
                                    "a2 - a3 - b0 - b3 + p0 >= -2",
                                    "- a1 - a2 - b0 + b1 - b3 + p0 >= -3"]
        self.sbox_inequalities[3] = ["- a1 + a3 - b1 - b2 + b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b1 - b3 + p0 >= -1",
                                    "- b0 + p2 >= 0",
                                    ...
                                    "- a1 - a2 - b0 - b1 + b2 + p0 >= -3",
                                    "- a0 - b0 + b1 - b2 - b3 - p0 >= -4"]
        self.sbox_inequalities[4] = ["- a1 + a3 - b0 - b1 + b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b0 - b3 + p0 >= -1",
                                    "- b2 + p2 >= 0",
                                    ...
                                    "a2 - a3 - b0 - b2 + p0 >= -2",
                                    "- a1 - a2 - b0 + b1 - b2 + p0 >= -3"]
        self.sbox_inequalities[5] = ["- a1 + a3 - b0 - b1 + b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b1 - b3 + p0 >= -1",
                                    "- b2 + p2 >= 0",
                                    ...
                                    "a2 - a3 - b1 - b2 + p0 >= -2",
                                    "- a1 - a2 + b0 - b1 - b2 + p0 >= -3"]
        self.sbox_inequalities[6] = ["- a1 + a3 - b0 + b2 - b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b2 - b3 + p0 >= -1",
                                    "- b1 + p2 >= 0",
                                    ...
                                    "- a0 - a1 + a2 + b0 - b1 - b2 - b3 >= -4",
                                    "- a1 - a2 + b0 - b1 - b3 + p0 >= -3"]
        self.sbox_inequalities[7] = ["- a1 + a3 - b0 + b2 - b3 >= -2",
                                    "p1 - p2 >= 0",
                                    "- p0 + p2 >= 0",
                                    "- b2 - b3 + p0 >= -1",
                                    "- b1 + p2 >= 0",
    ...
    def generate_constraints(self):
        ...
        for rn in range(self.nrounds):
            ...
            for n in range(8):
                ...
                constraints += self.constraints_by_sbox(sbn=0, di=x_in[n], do=y[n], pr=pr[n])
