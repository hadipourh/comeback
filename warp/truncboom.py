...
from truncdiff import Wordwarp
import time
from gurobipy import *

class TruncatedBoomerang(Wordwarp):
    """
    This class is used to find a truncated boomerang trail for WARP block cipher
    """
    ...
    def __init__(self, r0, r1, rm, w0=1, w1=1, wm=1):
        ...
        super().__init__()
        self.lp_file_name = f"warp_{r0}_{rm}_{r1}.lp"
        self.r0 = r0
        self.R0 = r0 + rm
        self.r1 = r1
        self.R1 = r1 + rm
