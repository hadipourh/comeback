...
#SBATCH --job-name=lblock                          # Name of job
...
#SBATCH --output=/workstore/hhadipour/boomerang/lblock_%A_%a.log                     # Standard output log
#SBATCH --error=/workstore/hhadipour/boomerang/lblock_%A_%a.err                     # Standard error log
#SBATCH --cpus-per-task=1                              # Number of cpus required per task
pwd; hostname; date
# Install python-sat
# make
./boomerang ${SLURM_ARRAY_TASK_ID}
date
